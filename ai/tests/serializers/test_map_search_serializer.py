"""Tests for the MapSearchInputSerializer."""
...
class TestMapSearchInputSerializer:
    """Tests for the MapSearchInputSerializer."""

    def test_valid_payload(self):
        """A fully valid payload should instantiate successfully."""
        serializer = MapSearchInputSerializer(**_valid_payload())
    ...
    def test_selected_text_strips_surrounding_whitespace(self):
        ...
        serializer = MapSearchInputSerializer(**_valid_payload(selected_text="  For God so loved  "))
    ...
    def test_selected_text_collapses_blank_lines(self):
        ...
        serializer = MapSearchInputSerializer(
    ...
    def test_selected_text_empty_raises(self):
        ...
        with pytest.raises(ValidationError):
            MapSearchInputSerializer(**_valid_payload(selected_text=""))
    ...
    def test_verses_text_strips_surrounding_whitespace(self):
        ...
        serializer = MapSearchInputSerializer(**_valid_payload(verses_text="  In the beginning  "))
    ...
    def test_verses_text_empty_raises(self):
        ...
        with pytest.raises(ValidationError):
            MapSearchInputSerializer(**_valid_payload(verses_text=""))
    ...
    def test_book_strips_surrounding_whitespace(self):
        ...
        serializer = MapSearchInputSerializer(**_valid_payload(book="  John  "))
    ...
    def test_book_empty_raises(self):
        ...
        with pytest.raises(ValidationError):
            MapSearchInputSerializer(**_valid_payload(book=""))
    ...
    def test_chapter_strips_surrounding_whitespace(self):
        ...
        serializer = MapSearchInputSerializer(**_valid_payload(chapter="  3  "))
    ...
    def test_chapter_empty_raises(self):
        ...
        with pytest.raises(ValidationError):
            MapSearchInputSerializer(**_valid_payload(chapter=""))
    ...
    def test_missing_required_field_raises(self):
        ...
        del payload["book"]
        with pytest.raises(ValidationError):
            MapSearchInputSerializer(**payload)
